    ...
    <x-auth-card>
        <div class="reset-card">
            ...
            <div class="reset-content">
                <div class="reset-art">
                    <svg class="art" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="951.23547"
                        height="632.16225" viewBox="0 0 951.23547 632.16225" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-124.38226 -133.06928)" fill="#FFDD4A" />
                        <path
                        ...
                        <circle id="e096411a-cdc3-4e6d-bbd4-4630e1fee17e"
                            data-name="ab6171fa-7d69-4734-b81c-8dff60f9761b" cx="238.3229" cy="228.39206"
                            r="88.86282" fill="#9e616a" />
                        ...
                        <polygon points="362.007 485.026 337.083 630.762 322.128 632.162 362.007 485.026"
                            opacity="0.2" />
                        <path
                            ...
                            transform="translate(-124.38226 -133.06928)" fill="#094074" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-124.38226 -133.06928)" fill="#094074" />
                        <circle cx="540.23547" cy="106.16225" r="15" fill="#094074" />
                        <circle cx="643.23547" cy="106.16225" r="15" fill="#094074" />
                        <circle cx="746.23547" cy="106.16225" r="15" fill="#094074" />
                        <circle cx="849.23547" cy="106.16225" r="15" fill="#094074" />
                    </svg>
                </div>
                <!-- Validation Errors -->
                ...
                <form method="POST" class="form" action="{{ route('password.update') }}">
                    ...
                    <div class="field">
                        ...
                        <x-input id="email" class="input" type="email" name="email" :value="old('email', $request->email)"
                            readonly />
                    </div>

                    <!-- Password -->
                    <div @class(['field', 'field-error' => $errors->has('password')])>
                    ...
                    <!-- Confirm Password -->
                    <div @class(['field', 'field-error' => $errors->has('password') && strpos($errors->first('password'), 'The password confirmation does not match.') !== false])>
                        <x-label for="password_confirmation" :value="__('Confirm Password')" />

                        <x-input id="password_confirmation" class="input" type="password"
                            name="password_confirmation" required />
                            @if ($errors->has('password') && strpos($errors->first('password'), 'The password confirmation does not match.') !== false)
                            <span class="error-text">
                                <strong>{{ $errors->first('password') }}</strong>
                            </span>
                        @endif
                    ...
                    <x-button color='primary' class="button">
                        {{ __('Reset Password') }}
                    </x-button>
                </form>
            </div>
